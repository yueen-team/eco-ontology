...
This project is indexed by GitNexus as **eco-ontology** (180 symbols, 282 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
