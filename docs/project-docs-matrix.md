...
| ADR              | Decision records   | `docs/adr/`                        | present | ADR-0001 through ADR-0006 record repository boundary, cutover, v0.1.0 package, evidence-based promotion, projection governance, and the bilingual registry surface plus intake grounding decisions. |
